...
int move_constructor() {
    // move constructors in C++ are like copy constructors but they transfer the
    // ownership from a previous object to the new one being instantiated.
    // transferring owneship entails transferring the ownership of the resources
    // such as:
    // - dynamically allocated memory
    // - file handles
    // - network connections
    // - data members in general
